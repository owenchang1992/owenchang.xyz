...
import { HomeIcon, GitHubLogoIcon, MoonIcon, SunIcon } from '@radix-ui/react-icons'
import {
  NavigationMenu,
  NavigationMenuItem,
  NavigationMenuLink,
        ...
        <NavigationMenuList className="max-w-2xl mx-auto">
          <NavigationMenuItem >
            <Link href="/" legacyBehavior passHref >
              <NavigationMenuLink className={cn(navigationMenuTriggerStyle(), "hover:bg-background pl-0")}>
